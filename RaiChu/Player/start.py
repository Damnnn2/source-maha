...
**مرحبا بك فـ سـوُرس ميوزك يتيح لك تشغيل الموسيقي والفيديو بدون اي مشكله وبدون تهنيج 🤍😊
        
امـامـك الـبـوت الـخـاص بـنـا..♡ [B𝗼𝘁 𝗺𝘂𝘀𝗶𝗰 𝗺𝗮𝗿𝗼](https://t.me/Q_Ll_Ubot)
...
⋆  [Hamdi](t.me/hhhamdi)
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "مـبرمج ألـسـوُرس..♡", url="https://t.me/X_A_R2"
                    ),
                    InlineKeyboardButton(
